...
export const changelog = [
  {
    date: '2026-08-03',
    type: 'content',
    title: 'Option 1 on “roll your own seed” was showing you the wrong procedure',
    detail: 'A correction on a safety-critical page, and it is the kind we would rather own loudly. The roll-your-own-seed page offers three methods and turns into whichever one you pick. Option 1 is the fully sovereign one: you choose every word yourself from our printed dice-to-word table, and your randomness never touches a machine at all. That is what the page said at the top of the panel. Then, four lines down, the steps told you to find the dice screen on your hardware wallet, enter each throw into it, and read the finished words off its screen — which is option 2, the opposite procedure, and the one thing option 1 exists to avoid. All three methods were being handed the same nine steps, and only two of them fitted. It also broke a promise made on the dice-to-word table itself, which tells you that you do not roll the last word and that the procedure on the site explains how, for each device. It did not. OPTION 1 NOW HAS ITS OWN TEN STEPS, and they describe what you actually do: print the table and read its method sheet first; know that you are choosing 23 words for a 24-word seed or 11 for a 12-word one, and that the last word is not one of them; roll, look up and write down one word at a time, rerolling any 5 or 6; count and check the spelling before the device is even switched on. THE DEVICE HAS EXACTLY ONE JOB IN THIS PROCEDURE and the steps now say so: the final word. That word carries the checksum — 8 bits of it for a 24-word seed, 4 for a 12-word one — which is arithmetic over every word before it, so there is no table entry for it and no way to reach it with a die. You use the device\'s import or restore flow rather than "create a new wallet", which reads oddly the first time and is correct, and it produces a valid final word: 8 possible ones for a 24-word seed, 128 for a 12-word one, because a few bits of your own randomness still live in that word alongside the checksum. Some devices calculate one for you and some offer the valid options and let you pick. The per-device menu paths underneath were right all along — Jade\'s "Calculate", BitBox\'s "pick one of the valid final words", Passport\'s "Generate Final Word" — which is exactly why the contradiction was worth fixing rather than papering over: the page was disagreeing with itself on one screen, and the half that was wrong was the half you would have followed.',
  },
  {
    date: '2026-08-02',
    type: 'feature',
    title: 'Your plan page points at the next thing — and we were miscounting your checklist',
  ...
  },
  {
    date: '2026-08-01',
    type: 'feature',
    title: 'The setup finder now reads your answer about the hardware you own',
  ...
  },
  {
    date: '2026-08-01',
    type: 'content',
    title: 'Bitkey is collaborative custody — for spending, not for a savings vault',
  ...
  },
  {
    date: '2026-08-01',
    type: 'content',
    title: 'The first risk section now admits it does not change the answer',
  ...
  },
  {
    date: '2026-08-01',
    type: 'content',
    title: 'A Tools & demos menu — and the course ends on running your own node',
  ...
  },
  {
    date: '2026-08-01',
    type: 'content',
    title: 'Our philosophy on the front page — and the seed options stop having a “default”',
  ...
  },
  {
    date: '2026-08-01',
    type: 'security',
    title: 'The Coldcard keeps its cold-storage rating — the review we promised, in full',
  ...
  },
  {
    date: '2026-08-01',
    type: 'feature',
    title: 'Generating your seed is now a lesson — and you can put your own randomness into it',
  ...
  },
  {
    date: '2026-08-01',
    type: 'spec',
    title: 'Fixed: your plan and checklist were broken if you own a Trezor, Jade Plus, Bitkey or Ledger',
