...
// dice procedure uses — words and throws are never typed here. (The PBKDF2
// iteration-count detail moved to /roll-your-own-seed 2026-08-04; 102 keeps the
...
export const ladder = [
  {
    ...
    mechanism: {
      ...
      points: [
        ...
        '<strong>What people try instead of metal, and why we don’t.</strong> Paper works until water or fire reaches it. Photos and password managers put your entire wallet on a machine that talks to the internet — the most common way a seed leaves a house. Memorising the words, or splitting the list by hand across two places, each fails in its own well-documented way (Shamir, the designed version of the splitting idea, gets its own treatment later in this level). The full tour of the clever schemes and why each one loses is in the backup lesson — <strong>Backing up a seed phrase</strong>, in 103 · Private key creation. Metal, kept somewhere fire and water don’t reach, is the boring answer that keeps working.',
      ],
    },
    gains: [
...

  {
    ...
    costs: [
      '<strong>Complexity — the top cause of lost Bitcoin.</strong> You now manage six sensitive items (three keys, three seed backups), plus the <a href="/glossary#wallet-descriptor">wallet descriptor</a> and <a href="/glossary#coordinator-software">coordinator software</a> — the desktop app that assembles the keys into one wallet.',
