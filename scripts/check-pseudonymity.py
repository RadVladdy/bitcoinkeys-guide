...
SITE = 'bitcoinkeys.guide'
BUILT = ['dist']        # what the public can actually fetch
SOURCE = ['src', 'scripts']      # what gets scanned for the two mechanisms
...
ALLOWED = [
           r'keys@bitcoinkeys\.guide',  # the site's own contact address, published on purpose
           r'Bitcoineconomyai@gmail\.com',  # the sibling brand's contact address
           r'noreply',  # git noreply addresses
]
# Whole paths excluded from the identifier scan.
EXCLUDE_PATHS = []
